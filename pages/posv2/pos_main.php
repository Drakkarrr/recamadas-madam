                            ...
                            <form method="post">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="category" class="form-control input-sm select2" style="width:100">
                                        <option value="*" <?= ($cat_id=="*") ? "SELECTED" : "";  ?> >-- All Categories --</option>
                                        <option value="1" <?= ($cat_id=="1") ? "SELECTED" :  ""; ?> >Lens</option>
                                        <option value="2" <?= ($cat_id=="2") ? "SELECTED" :  ""; ?> >Frame</option>
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="code" class="form-control input-sm select2" value="<?= $_POST['code'] ?? '' ?>">
                            ...
                            <div class="box" style="overflow-y: auto; max-height: 300px; max-width: 1700px;">
                                <div class="box-header">
                                    ...
                                    if ( isset($_POST['category']) ) {
                                        ...
                                        $productsQuery = mysqli_query($con, "SELECT * FROM tblproduct WHERE cat_id LIKE '%{$cat_id}%' AND code LIKE '%$code%' AND is_delete=0 ORDER BY id DESC");
                                        ...
                                        while ($row = mysqli_fetch_array($productsQuery)) {
                                            ...
                                            echo '<h5 class="card-title">';
                                                echo "{$row['name']}<br> {$row['code']}<br> ₱{$row['price']}"; 
                                            echo '</h5>';
                                    ...
                                    <div class="box-body table-responsive" style="height: 320px; overflow-y: auto;">
                                        <form method="post">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $user = mysqli_query($con, "SELECT * FROM tbluser WHERE id = '" . $_SESSION['userid'] . "'  ORDER BY id DESC");
                                                    $order_id = "";
