                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Code:</label>
                                    <input name="a_code" class="form-control input-sm" type="text" required=""/>
                                </div>
                                ...
                                <div class="form-group div-lens">
                                    ...
                                    <input name="a_prescription" class="form-control input-sm" type="text" required=""/>
                                </div>
                                ...
                                <div class="form-group div-frame">
                                    ...
                                    <input name="a_date_ordered" class="form-control input-sm" type="date"/>
                                </div>
                                
                                <div class="form-group div-frame">
                                    <label>Frame Brand:</label>
                                    <input name="a_frame_brand" class="form-control input-sm" type="text"/>
                                </div>

                                <div class="form-group div-frame">
                                    <label>Frame Type:</label>
                                    <input name="a_frame_type" class="form-control input-sm" type="text"/>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#addModal [name=a_category]").change(function(){


            let val = $(this).val();
            if(val==2){
                //FRAME
                $("#addModal .div-lens").css("display","none");
                $("#addModal .div-frame").css("display","block");

                $("#addModal .div-lens").find("input").prop("required",false);
                $("#addModal .div-frame").find("input").prop("required",true);

            }else{
                //LENS
                $("#addModal .div-lens").css("display","block");
                $("#addModal .div-frame").css("display","none");

                $("#addModal .div-lens").find("input").prop("required",true);
                $("#addModal .div-frame").find("input").prop("required",false);
            }
